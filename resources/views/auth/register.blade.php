            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="/register-post" method="POST">
                            @csrf
                            @method('post')
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="saldo" class="form-label">Jumlah saldo yang akan dikelola</label>
                                <input type="number" class="form-control" id="saldo" name="saldo"
                                    placeholder="Masukkan Saldo" autofocus />
                            </div>
                            {{-- <div class="mb-3">
